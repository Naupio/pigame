...
msg_type(2001) -> userInfoReq;
msg_type(2002) -> userInfoResp;
...
msg_code(userInfoReq) -> 2001;
msg_code(userInfoResp) -> 2002.
...
decoder_for(2001) -> maininterface_pb;
decoder_for(2002) -> maininterface_pb.